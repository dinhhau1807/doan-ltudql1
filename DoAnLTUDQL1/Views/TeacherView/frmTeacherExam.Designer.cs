namespace DoAnLTUDQL1.Views.TeacherView
{
    partial class frmTeacherExam
    {
        ...
        private void InitializeComponent()
        {
			...
			this.mGridListExam.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
			...
			this.mGridListExam.DefaultCellStyle = dataGridViewCellStyle5;
			...
			this.mGridListExam.RowHeadersDefaultCellStyle = dataGridViewCellStyle6;
			...
			// 
			this.mDateTimeEditDateStart.CustomFormat = "mm/MM/yyyy";
